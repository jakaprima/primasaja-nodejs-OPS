...
// module.exports = app ;
;var _temp = function () {if (typeof __REACT_HOT_LOADER__ === 'undefined') {return;}__REACT_HOT_LOADER__.register(setupAppRoutes, 'setupAppRoutes', 'src/server/index.js');__REACT_HOT_LOADER__.register(app, 'app', 'src/server/index.js');__REACT_HOT_LOADER__.register(port, 'port', 'src/server/index.js');__REACT_HOT_LOADER__.register(ip, 'ip', 'src/server/index.js');__REACT_HOT_LOADER__.register(mongoURL, 'mongoURL', 'src/server/index.js');__REACT_HOT_LOADER__.register(mongoURLLabel, 'mongoURLLabel', 'src/server/index.js');__REACT_HOT_LOADER__.register(mongoServiceName, 'mongoServiceName', 'src/server/index.js');__REACT_HOT_LOADER__.register(mongoHost, 'mongoHost', 'src/server/index.js');__REACT_HOT_LOADER__.register(mongoPort, 'mongoPort', 'src/server/index.js');__REACT_HOT_LOADER__.register(mongoDatabase, 'mongoDatabase', 'src/server/index.js');__REACT_HOT_LOADER__.register(mongoPassword, 'mongoPassword', 'src/server/index.js');__REACT_HOT_LOADER__.register(db, 'db', 'src/server/index.js');__REACT_HOT_LOADER__.register(dbDetails, 'dbDetails', 'src/server/index.js');__REACT_HOT_LOADER__.register(initDb, 'initDb', 'src/server/index.js');}();;