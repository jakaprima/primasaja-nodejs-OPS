...
var template = function(){
  return `
    <html ng-app="angularmodule">
      ...
      <script src="layanan/app.js"></script>
      
      </head>
      <base href="/"></base>
      <body>
        <a ui-sref="index" ui-sref-active="active">menu1</a>
        <a ui-sref="about" ui-sref-active="active">menu2</a>
        <ui-view></ui-view>
      </body>
...
app.get(urlCollection.view2, (req, res) => {
  res.send(template2());
});

app.get(urlCollection.about, (req, res) => {
